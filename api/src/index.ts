...
import { walletRoutes, confirmoWebhookHandler } from './routes/wallet'
...
// Confirmo webhook — NO auth required (has its own HMAC sig verification)
app.post('/api/webhook/confirmo', confirmoWebhookHandler)
